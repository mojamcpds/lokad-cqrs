...
namespace Lokad.Cqrs.AzureViews
{
	...
	public class ViewStorageEntity : TableServiceEntity
	{
		/// <summary>
		...
		//public static ViewEntity Convert(ViewStorageEntity viewStorageEntity, IDataSerializer formatter, string etag, Type type)
		//{
		//    using (var stream = new MemoryStream(viewStorageEntity.GetData()) )
		//    {
		//        var val = formatter.Deserialize(stream, type);

		//        return new ViewEntity
		//        {
		//            PartitionKey = viewStorageEntity.PartitionKey,
		//            RowKey = viewStorageEntity.RowKey,
		//            Timestamp = viewStorageEntity.Timestamp,
		//            ETag = etag,
		//            Value = val
		//        };
		//    }
		...
		//public static ViewStorageEntity Convert<T>(ListEntry<T> listEntry, IDataSerializer formatter)
		//{
		//    var stream = new MemoryStream();
		//    formatter.Serialize(listEntry.Value, stream);

		//    var fatEntity = new ViewStorageEntity
		//        {
		//            PartitionKey = listEntry.PartitionKey,
		//            RowKey = listEntry.RowKey,
