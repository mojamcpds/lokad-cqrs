...
namespace Lokad.Rules
{
    ...
    public static class Scope
    {
            ...
            params Rule<TItem>[] rules)
        {
            ...
            return ScopeFactory.GetMessages(sequenceReference,
                scope => scope.ValidateInScope(sequenceReference(), rules));
        }
        ...
        /// <param name="rules">The rules to execute.</param>
        /// <returns>read-only collection of <see cref="RuleMessage"/></returns>
        public static RuleMessages GetMessagesForMany<TItem>(IEnumerable<TItem> items, string name,
            params Rule<TItem>[] rules)
        {
            if (name == null) throw new ArgumentNullException("name");
        ...
        /// </summary>
        [UsedImplicitly] public const char RulePathSeprator = '.';
