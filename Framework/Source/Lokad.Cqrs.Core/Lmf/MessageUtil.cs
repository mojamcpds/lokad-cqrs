...
namespace Lokad.Cqrs.Lmf
{
    public static class MessageUtil
    {
        ...
        public static MemoryStream SaveDataMessageToStream(MessageAttributesContract messageAttributes,
        ...
        public static IEnumerable<UnpackedMessage> ReadDataMessagesFromStream(Stream stream,
